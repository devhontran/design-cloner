...
const ALTERNATIVES = {
  ...
  'zimula': 'Figtree', 'ktf metro roman': 'Marcellus', 'ktf metro blueline': 'Michroma', 'suissebpintl': 'Inter', 'sometype': 'Sometype Mono', 'ambroise francois std': 'Bodoni Moda', 'ambroise-francois-std': 'Bodoni Moda', 'maison neue extended': 'Archivo', 'maison neue': 'Inter',
};
