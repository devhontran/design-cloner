...
const ALTERNATIVES = {
  ...
  'clarendonbtwxx-light': 'Rokkitt', 'nb_internationalprolight': 'Inter', 'nb_internationalproregular': 'Inter', 'labilgroteskregular': 'Figtree', 'brown pro': 'Inter', 'clearface itc w01': 'Libre Baskerville', 'aeonik': 'Figtree', 'lusionmono': 'IBM Plex Mono', 'ibmplexmono-medium': 'IBM Plex Mono', 'hk guise': 'Urbanist', 'pp mori': 'Manrope', 'nib pro': 'Newsreader', 'apercu pro': 'DM Sans', 'apercu mono pro': 'DM Mono', 'f37judge': 'Anton', 'f37judge-extended': 'Archivo', 'avantt': 'Plus Jakarta Sans', 'soehne': 'Inter', 'abcarizonamix': 'Newsreader', 'twkfont': 'Inter Tight', 'herbikfont': 'Instrument Serif', 'bt grotesk medium': 'Archivo', 'bt grotesk regular': 'Archivo', 'bt grotesk': 'Archivo', 'bt glyphius regular': 'Instrument Serif', 'denimweb': 'Inter Tight', 'denim': 'Inter Tight', 'krissai': 'Manrope', 'zentryscreamer': 'Anton', 'zentry screamer': 'Anton', 'steelfish-eb': 'Big Shoulders Display', 'steelfish': 'Big Shoulders Display', 'fkgrotesk': 'Inter', 'fkgrotesk-medium': 'Inter', 'nt dapper': 'Archivo', 'alliance neue': 'Inter', 'alliance platt': 'Newsreader', 'nbarchitekt': 'Space Mono', 'nb architekt': 'Space Mono', 'khtekatrial': 'Inter Tight', 'khteka': 'Inter Tight', 'century gothic': 'Josefin Sans', 'bardford': 'Newsreader', 'bradford': 'Newsreader', 'neuemontreal': 'Inter', 'gt-america': 'Inter Tight', 'halyard display': 'Hanken Grotesk', 'halyard-display-variable': 'Hanken Grotesk', 'zimula': 'Figtree', 'ktf metro roman': 'Marcellus', 'ktf metro blueline': 'Michroma', 'suissebpintl': 'Inter', 'sometype': 'Sometype Mono', 'ambroise francois std': 'Bodoni Moda', 'ambroise-francois-std': 'Bodoni Moda', 'maison neue extended': 'Archivo', 'maison neue': 'Inter',
};
